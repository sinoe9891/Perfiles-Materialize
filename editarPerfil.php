    ...
    <div class="row">
      <div align="center" class="col s12 m12 l12">
         ...
         <div class="row">
            <div class="col s12"><h5>Datos Univeristarios</h5></div>
                ...
                <div class="input-field col l3 m6 s12">
                    ...
                    <input placeholder="" value="<?php echo $_GET['orientacion']; ?>" disabled id="name" type="text" class="active validate" required>
        ...
        <div class="input-field col l4 m6 s12">
            ...
            <input placeholder="" value="<?php echo $_GET['asesor_pasantia']; ?>" id="name" type="text" class="active validate" required>
        ...
        <div class="input-field col l4 m6 s12">
            ...
            <input placeholder="" value="<?php echo $_GET['url_pasantia']; ?>" id="name" type="text" class="active validate" required>
