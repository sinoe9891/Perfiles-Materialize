<?php
   ...
   //                  <option value="077741">INGENIERO EN AMBIENTE Y DESARROLLO</option>
		...
		$sql = "UPDATE `graduat3s` SET `ID` = '{$_POST['ID']}', `codigo` = '{$_POST['codigo']}', `nombres` = '{$_POST['nombres']}', `apellidos` = '{$_POST['apellidos']}', `nacionalidad` = '{$_POST['nacionalidad']}', `genero` = '{$_POST['genero']}', `programa` = '{$programa}', `orientacion` = '{$orientacion}', `dia_graduacion` = '{$_POST['diaGraduacion']}', `mes_graduacion` = '{$_POST['mesGraduacion']}', `estatus` = '{$_POST['estatus']}', `lugar_pasantia` = '{$_POST['lugarPasantia']}', `exp_pasantia` = '{$_POST['exp_pasantia']}', `area_investigacion` = '{$_POST['area_investigacion']}', `asesor_tesis` = '{$_POST['asesor_tesis']}', `url_pasantia` = '{$_POST['url_pasantia']}', `titulo` = '{$_POST['titulo']}', `fecha_nacimiento` = '{$_POST['fechaNacimiento']}', `financiado_por` = '{$_POST['financiado_por']}', `direccion` = '{$_POST['direccion']}', `email` = '{$_POST['email']}', `telefono` = '{$_POST['telefono']}', `movil` = '{$_POST['movil']}' WHERE `graduat3s`.`ID` = '{$_POST['ID']}'";
